    ...
    <div className="w-full max-w-3xl px-4 pb-4">
      <div className="relative flex flex-col w-full rounded-2xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/80 shadow-md focus-within:ring-2 focus-within:ring-emerald-500/30 focus-within:border-emerald-500 transition-all duration-200">
        <textarea
          ...
          className="w-full px-4 pt-4 pb-12 bg-transparent text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none resize-none min-h-[52px] leading-relaxed text-sm md:text-base"
        />
        ...
        <button
          ...
          className={`absolute bottom-3 right-3 p-2 rounded-xl text-white transition-all duration-200 ${
            input.trim() 
              ...
              : 'bg-gray-300 dark:bg-gray-700 text-gray-400 dark:text-gray-500 cursor-not-allowed scale-95'
          }`}
          title="Send message"
        >
